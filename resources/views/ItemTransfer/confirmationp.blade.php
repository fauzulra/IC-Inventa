    ...
    @section('title', 'Konfirmasi Transfer Barang')

    @section('content')
        <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-md border border-gray-200">

            <h2 class="text-xl font-semibold text-gray-800 mb-16">Konfirmasi Transfer Barang Antar Proyek</h2>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse border border-gray-200">
                    ...
                    <tbody id="tableBody" class="text-sm text-gray-600">
                        {{-- Ganti $orders menjadi $transfers --}}
                        @forelse ($transfers as $transfer)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="border border-gray-200 px-4 py-3 text-center">
                                    @php
                                        // Logika warna badge status transfer
                                        ...
                                        } elseif ($statusLow == 'dikirim' || $statusLow == 'berjalan') {
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-6 text-gray-500 border border-gray-200">
                                    Belum ada pengajuan transfer yang perlu dikonfirmasi.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
                ...
                <div
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                        <form id="statusForm" method="POST" action="">
                            ...
                            @method('PUT')
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2">Item yang ditransfer</label>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="space-y-3">
                                    <label
                                        ...
                                        <input type="radio" name="status" value="Dikirim" required
                                            class="h-4 w-4 text-blue-400 focus:ring-blue-400 border-gray-300">
                                        <span
                                            class="ml-3 flex-1 block font-medium text-gray-700 group-hover:text-blue-600">Sedang
                                            Dikirim</span>
                                        <span
                                    ...
                                    <label
                                        ...
                                        <span
                                            class="ml-3 flex-1 block font-medium text-gray-700 group-hover:text-green-600">Diterima
                                            Tujuan</span>
                                        <span
                                    ...
                                    <label
                                        ...
                                        <span
                                            class="ml-3 flex-1 block font-medium text-gray-700 group-hover:text-red-600">Ditolak
                                            / Batal</span>
                                        <span
    ...
    @section('script')
        <script>
            // JS Menerima parameter transferId dan nama item material
            function openStatusModal(transferId, itemName) {
                // 1. Tampilkan nama item di dalam form modal
                document.getElementById('modalItemName').value = itemName;

                // 2. Ubah URL form action menuju route itemtransfer.confirmation.update
                document.getElementById('statusForm').action = "/itemtransfer/confirmation/" + transferId;
