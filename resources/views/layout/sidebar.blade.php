<nav class="flex-1 space-y-1">
    <a href="{{ route('dashboard') }}" class="group flex items-center  text-sm font-medium text-gray-800 bg-[#D9D9D9]">
    ...
    <a href="{{ route('project.index') }}"
        class="group flex items-center  text-sm font-medium text-gray-800 hover:bg-gray-50 ">
        <div class="flex items-center text-gray-600">
        ...
        {{-- <i class="fas fa-helmet-safety px-6 py-4 text-gray-600"></i> Proyek --}}
    </a>
    <a href="{{ route('material.index') }}"
        class="group flex items-center  text-sm font-medium text-gray-800 hover:bg-gray-50 ">
        {{-- <i class="fas fa-layer-group px-6 py-4 text-gray-600"></i> Material Item --}}
        <div class="flex items-center text-gray-600">
    ...
    <a href="{{ route('supplier.index') }}"
        class="group flex items-center  text-sm font-medium text-gray-800 hover:bg-gray-50 ">
        {{-- <i class="fas fa-truck px-6 py-4 text-gray-600"></i> Pemasok --}}
        <div class="flex items-center text-gray-600">
    ...
    <a href="{{ route('incominggood.index') }}"
        class="group flex items-center  text-sm font-medium text-gray-800 hover:bg-gray-50 ">
        {{-- <i class="fas fa-arrow-down px-6 py-4 text-gray-600"></i> Barang Masuk --}}
        <div class="flex items-center text-gray-600">
    ...
    <a href="{{ route('outgoinggood.index') }}"
        class="group flex items-center  text-sm font-medium text-gray-800 hover:bg-gray-50 ">
        {{-- <i class="fas fa-truck px-6 py-4 text-gray-600"></i> Barang Keluar --}}
        <div class="flex items-center text-gray-600">
    ...
    <a href="{{ route('itemtransfer.index') }}"
        class="group flex items-center  text-sm font-medium text-gray-800 hover:bg-gray-50 ">
        {{-- <i class="fas fa-truck px-6 py-4 text-gray-600"></i> Transfer Barang --}}
        <div class="flex items-center text-gray-600">
    ...
    <a href="{{ route('confirmation.index') }}"
        class="group flex items-center  text-sm font-medium text-gray-800 hover:bg-gray-50 ">
        {{-- <i class="fas fa-truck px-6 py-4 text-gray-600"></i> Pemesanan --}}
        <div class="flex items-center text-gray-600">
